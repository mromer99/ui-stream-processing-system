...
def register_callbacks(app):
    ...
    def update_tooltip(mouseoverNode, mouseoverEdge, mouseoutNode, mouseoutEdge):
            ...
            if ctx_trigger:
                ...
                # When hovering over a node, display its CPU and Memory info next to the mouse.
                if "mouseoverNodeData" in prop_id and mouseoverNode:
                    ...
                    # Try to get the mouse position from the event data. 
                    # (Ensure your cytoscape component sends the position info.)
                ...
                # When hovering over an edge, display its Bandwidth info next to the mouse.
